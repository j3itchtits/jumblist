...
%>
        ...
        <h3>Category</h3>
        <label for="postCategorySelection" class="hide">Select Post Category</label>
...
--%>
        <h3>Tags</h3>
        <label for="tagSearch" class="hide">Enter Tags</label>
        ...
        { %>
            <h3>Location</h3>
            Within <label for="locationRadius" class="hide">Enter seach radius in miles</label><%= Html.TextBox( "locationRadius", Html.LocationRadius( Model.UserSearchArea.Radius ) )%> miles of 
            <label for="locationSearch" class="hide">Enter seach location</label><%= Html.TextBox( "locationSearch", Html.LocationName( Model.UserSearchArea.LocationName ) )%><br /><br /> <% 
        }
