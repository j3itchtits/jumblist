...
<% foreach ( var location in Model )
   { %>
        <tr class="item">
            ...
            <td>[ <%= Html.ActionLink( "List Posts", "location", "posts", new { id = location.LocationId }, null )%> ]</td> 
            <td>[ <%= Html.ActionLink( "List Posts", "location", "posts", new { id = location.Name.ToFriendlyUrl() }, null )%> ]</td> 
        </tr> 
<% } %>
</table>         
